...
const pillars = [
  ...
  { title: 'Sofisticação', copy: 'Cada detalhe pensado para um resultado leve e elegante.', Icon: Heart },
];
  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <svg className="essence-thread essence-thread-desktop" viewBox="0 0 1440 740" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl`} cx="30%" cy="25%"><stop stopColor="#f7eee7"/><stop offset=".5" stopColor="#c08462"/><stop offset="1" stopColor="#7f3824"/></radialGradient></defs>
      ...
      <svg className="essence-thread essence-thread-mobile" viewBox="0 0 400 900" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl-mobile`} cx="30%" cy="25%"><stop stopColor="#f7eee7"/><stop offset=".5" stopColor="#c08462"/><stop offset="1" stopColor="#7f3824"/></radialGradient></defs>
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">A sua beleza faz parte de quem você é. Cuidar dela é valorizar seus traços, sua expressão e tudo o que torna você única.</p>
      ...
      <p className="essence-margin-note">RESULTADOS REAIS<br/>HISTÓRIAS ÚNICAS<span aria-hidden="true"/></p>
    </div>
